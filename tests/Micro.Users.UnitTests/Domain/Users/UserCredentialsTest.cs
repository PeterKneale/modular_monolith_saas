...
public class UserCredentialsTest
{
    ...
    {
        var userCredentials1 = new UserCredentials(EmailAddress.CreateInstance(email1), new Password(password1));
        var userCredentials2 = new UserCredentials(EmailAddress.CreateInstance(email2), new Password(password2));
