...
{
    private const string Template = "Username={0};Password={1};Database={2};Host={3};Port={4};Search Path={5};Include Error Detail=true;Log Parameters=true";
    ...
    public static string GetDbConnectionString(this IConfiguration configuration, string schema)
    {
        ...
        var connectionString = string.Format(Template, username, password, database, host, port, schema);
